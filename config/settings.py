...
# If SMTP credentials are configured, use SMTP backend; otherwise use console for debugging
if EMAIL_HOST_USER and EMAIL_HOST_PASSWORD:
    EMAIL_BACKEND = "django.core.mail.backends.smtp.EmailBackend"
else:
    EMAIL_BACKEND = "django.core.mail.backends.console.EmailBackend"  # Fallback if no SMTP configured
